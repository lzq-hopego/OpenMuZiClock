...
// String title_font="sim";//默认


enum CurrentPage{
  SETTING, WEATHER, AIR, FUTUREWEATHER, THEME, TIMER, RESET,CPU,PLAYSONG,MINUTE,HOUR,TEST
};
// 定义结构体
typedef struct {
  String text;
...
<!DOCTYPE html><html lang='zh'>
    ...
    <body>
        ...
        <form action='http://192.168.1.1/' method='post' id='form' accept-charset="UTF-8">
...
<div class='titleOption commonWidth'>和风天气key</div>
<input type='text' placeholder='输入和风天气的key' name='key' id='key' class='passAndCity commonWidth'>
<div class='titleOption commonWidth'>设备名</div>
<input type='text' placeholder='请输入设备名' name='title' id='title' class='passAndCity commonWidth'>
<div class='titleOption commonWidth'>城市名称（ 无需"市区县", 例 : 上蔡 ）</div>
...
function setWidth(width){
    ...
    nodes[8].setAttribute('style',width);
    nodes[9].setAttribute('style',width);
    nodes[10].setAttribute('style',width);
    nodes[11].setAttribute('style',width);
}
if(screenWidth > 1000){
